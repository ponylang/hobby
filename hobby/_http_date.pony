...
primitive _HTTPDate
  ...
  Uses `PosixDate` from stdlib. Despite the `PosixDate` docstring
  claiming "Monday is 1", the C runtime copies `tm_wday` directly
  (verified in `ponyc/src/libponyrt/lang/time.c`), so
